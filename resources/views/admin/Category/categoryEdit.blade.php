...
@endif
<form class="form-add" action="{{route('admin.categories.handleEdit',['id'=>$categoryDetail->id])}}"  method="POST">
    @csrf
    <div class="mb-3">
    ...
    <div class="contain-btn">
        ...
        <button type="button" class="form_submit-btn btn btn-warning">
            <a href={{route('admin.categories.list')}} style="text-decoration: none">Back</a>
        </button>
    </div>
    </form>
</div>
